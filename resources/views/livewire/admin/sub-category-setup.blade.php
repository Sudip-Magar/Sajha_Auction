            ...
            @scope('cell_status', $subCategory)
                <div class="flex items-center gap-2">
                    <div @class([
                        ...
                        'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]' => $subCategory->status === \App\Enums\StatusState::ACTIVE,
                        'bg-gray-300' => $subCategory->status !== \App\Enums\StatusState::ACTIVE,
                    ])></div>
                    <span @class([
                        'text-xs font-black uppercase tracking-tighter',
                        'text-green-600' => $subCategory->status === \App\Enums\StatusState::ACTIVE,
                        'text-gray-400' => $subCategory->status !== \App\Enums\StatusState::ACTIVE,
                    ])>{{ $subCategory->status->label() }}</span>
                </div>
            @endscope
